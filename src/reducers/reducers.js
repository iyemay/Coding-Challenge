...
export const initialState = {
    ...
    quiz: [
        {
            id: "challenge1",
            text: "In the last 12 months, my household spent...",
            ...
            answers: [{
                ...
                {
                    id: "0fd7bdb-fc99-44e2-83d6-3487721bb90d",
        ...
        },
        {
            ...
            help: "Imagine everyone in your household stopped making money. You couldn’t use your retirement" +
                " accounts, or borrow money from anyone. All you had was what you have now in cash, checking, " +
                "and savings accounts. If all your bills and spending stayed the same, how long before you " +
                "couldn’t cover your spending?",
            required: true,
            answers: [{
        ...
        },
        {
            ...
            help: "Example goals: saving for a vacation, starting a business, buying or paying off a home," +
                "saving up for education, putting money away for retirement, or making retirement funds last",
            required: true,
            answers: [{
        ...
        },
        {
            ...
            required: false,
            answers: [{
                id: "a0da6056-435c-4177-9671-b26e20673e31",
                text: "18-25"
            }, {
                id: "3163f045-ff47-49ed-8ab4-ec8b5687a0c1",
                text: "26-35"
            }, {
                id: "5cb25fd7-f378-48b4-9092-6037e20cc11d",
                text: "36-49"
            }, {
                id: "32830bca-ae0e-494e-b636-0d66a8a15db5",
                text: "50-64"
            }, {
                id: "a497c0a1-0dbc-4232-8b31-e599d0735e67",
                text: "65 and over"
            }]
        },
        {
            ...
            answers: [{
                ...
                id: "dd78bce1-ae3f-4166-aa04-f3fb1318ca1f",
                text: "Some college"
            }, {
                id: "9e8cf95c-b1b7-451b-a1a8-fb2ae086d9b9",
                text: "High school"
            }, {
        ...
        },
        {
            ...
            required: false,
            answers: [{
                id: "dd99cf75-4cb1-4473-b824-f6f4bcdba77d",
                text: "$100,000 or more"
            }, {
                id: "50050f6c-2421-40a5-ab0e-dc4c1ae5abba",
                text: "$60,000 - $99,999"
            }, {
                id: "75b487a3-7de9-4868-8836-bdf50b2d2f63",
                text: "$30,000 - $59,999"
            }, {
                id: "a5460cd0-3c8b-4b8e-8dcc-040fc80f111e",
